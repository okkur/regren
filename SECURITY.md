...
Please report any suspected security vulnerabilities privately to marco_ebert@icloud.com.
...
You are not allowed to search for security vulnerabilities on any hosted service of regren without the consent of the party hosting it.
regren is open source software and can be installed for testing and security issues on your own infrastructure.
