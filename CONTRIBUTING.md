...
Thank you for your interest in contributing to regren.  
This guide helps make contributing to regren simple and efficient for everyone.

### First contribution

If you are starting out contributing to regren, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/okkur/regren/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the regren wants to achieve, please open up an issue first.
